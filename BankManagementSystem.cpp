...
class Bank {
  ...
  public:
    ...
    //Depositing amount in to account
    void depositAmt() {
...
//2.Display all the customer details
...
//7. Retreive the name of the account holder
...
//8.Retreive the address of the account holder
...
//9.Retreive the balance of the account holder
